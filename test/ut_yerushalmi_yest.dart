...
void main() {
  ...
  test('testCorrectDaf1', () async {
    JewishCalendar jewishCalendar = new JewishCalendar.initDate(5777, 6, 10);
  ...
  test('testCorrectDaf2', () async {
    JewishCalendar jewishCalendar = new JewishCalendar.initDate(5744, 9, 1);
  ...
  test('testCorrectDaf3', () async {
    JewishCalendar jewishCalendar = new JewishCalendar.initDate(5782, 3, 1);
  ...
  test('testCorrectSpecialDate', () async {
    JewishCalendar jewishCalendar = new JewishCalendar.initDate(5775, 7, 10);
