...
class TefilaRules {
  ...
  /**
	...
	bool isVeseinTalUmatarStartDate(JewishCalendar jewishCalendar) {
        ...
        && jewishCalendar.getJewishMonth() == JewishDate.CHESHVAN && jewishCalendar.getJewishDayOfMonth() == 7) {
	...
	bool isMashivHaruachRecited(JewishCalendar jewishCalendar) {
		JewishDate startDate = new JewishDate.initDate(
      jewishYear: jewishCalendar.getJewishYear(),
      jewishMonth: JewishDate.TISHREI,
      jewishDayOfMonth: 22
    );

		JewishDate endDate = new JewishDate.initDate(
      jewishYear: jewishCalendar.getJewishYear(),
